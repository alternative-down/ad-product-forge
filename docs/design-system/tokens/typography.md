...
```jsx
<h3 className="text-xl font-semibold text-gray-900">Budget Overview</h3>
```

### Body Text

```jsx
<p className="text-base text-gray-600">Configure your agent's budget and schedule settings.</p>
```

### Button Text

```jsx
<Button className="text-sm font-medium">Top Up Budget</Button>
```
