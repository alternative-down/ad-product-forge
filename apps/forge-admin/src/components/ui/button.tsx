  ...
  return (
    <button
      className={cn(
        ...
        variant === 'primary' &&
          'border-[color:var(--accent)] bg-[color:var(--accent)] text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.08)] hover:opacity-90',
        variant === 'secondary' &&
        ...
        variant === 'danger' &&
          'border-red-300 bg-red-50 text-red-700 hover:opacity-90',
        className,
      )}
      {...props}
    />
