...
const MODEL_PRICES = [
  ...
  {
    modelKey: 'account-oauth/claude-max/claude-opus-4-6',
    inputPerMillionUsd: 5,
    inputCachePerMillionUsd: 0.5,
    outputPerMillionUsd: 25,
  },
  {
    modelKey: 'account-oauth/claude-max/claude-sonnet-4-6',
    inputPerMillionUsd: 3,
    inputCachePerMillionUsd: 0.3,
    outputPerMillionUsd: 15,
  },
  {
    modelKey: 'account-oauth/claude-max/claude-haiku-4-5',
