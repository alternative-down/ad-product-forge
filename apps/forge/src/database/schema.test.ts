...
import type {
  ...
  NewAgentRole,
  RoleToolPermission,
  NewRoleToolPermission,
  RoleWorkflowPermission,
  NewRoleWorkflowPermission,
  SystemSettings,
  NewSystemSettings,
  AgentExecutionContract,
  NewAgentExecutionContract,
  AgentExecutionStep,
  ...
  NewAgentSchedule,
  InternalChatAccount,
  NewInternalChatAccount,
  InternalChatConversation,
  NewInternalChatConversation,
  InternalChatConversationMember,
  NewInternalChatConversationMember,
  InternalChatMessage,
  NewInternalChatMessage,
  InternalChatMessageRead,
  NewInternalChatMessageRead,
  InternalChatMessageAttachment,
  NewInternalChatMessageAttachment,
  LlmModelPrice,
  NewLlmModelPrice,
  CompanyCashLedgerEntry,
  NewCompanyCashLedgerEntry,
  CompanyRecurringPayable,
  NewCompanyRecurringPayable,
  MigaduSystemIntegrationConfig,
  CoolifySystemIntegrationConfig,
  GitHubSystemIntegrationConfig,
  MinimaxSystemIntegrationConfig,
  SystemIntegrationConfigMap,
  SystemIntegration,
  NewSystemIntegration,
  LlmProfile,
  NewLlmProfile,
  SystemLlmDefaults,
  NewSystemLlmDefaults,
  AgentProvider,
  NewAgentProvider,
} from './schema';
  ...
  describe('types are exported and instantiable', () => {
    ...
    it('RoleToolPermission type', () => {
      const p = {
        ...
        createdAt: 0,
        updatedAt: 0,
      } as unknown as RoleToolPermission;
    ...
    it('RoleWorkflowPermission type', () => {
      const p = {
        ...
        createdAt: 0,
        updatedAt: 0,
      } as unknown as RoleWorkflowPermission;
    ...
    it('AgentExecutionContract type', () => {
      const c = {
        ...
        isActive: 1,
        createdAt: 0,
      } as unknown as AgentExecutionContract;
    ...
    it('NewAgentExecutionContract type', () => {
      const c = {
        ...
        startsAt: 0,
        endsAt: 1000,
      } as unknown as NewAgentExecutionContract;
      expect(c.budgetUsd).toBe(100);
    });
    ...
    it('NewAgentExecutionStep type', () => {
      const s = {
        ...
        outputTokens: 0,
        costUsd: 0,
      } as unknown as NewAgentExecutionStep;
    ...
    it('AgentHomeMetricSnapshot type', () => {
      const m = {
        ...
        snapshot: '{}',
        createdAt: 0,
      } as unknown as AgentHomeMetricSnapshot;
    ...
    it('NewAgentHomeMetricSnapshot type', () => {
      const m = {
        ...
        stepCreatedAt: 0,
        snapshot: '{}',
      } as unknown as NewAgentHomeMetricSnapshot;
      expect(m.agentId).toBe('a1');
    });
    ...
    it('AgentCheckpointedOmState type', () => {
      const s = {
        ...
        createdAt: 0,
        updatedAt: 0,
      } as unknown as AgentCheckpointedOmState;
    ...
    it('AgentLongTermMemoryRecallState type', () => {
      const s = {
        ...
        createdAt: 0,
        updatedAt: 0,
      } as unknown as AgentLongTermMemoryRecallState;
      expect(s.agentId).toBe('a1');
    });
    ...
    it('NewAgentSchedule type', () => {
      const s = {
        ...
        cronExpression: '0 8 * * *',
        isActive: 1,
      } as unknown as NewAgentSchedule;
    ...
    it('SystemLlmDefaults type', () => {
      const d = {
        id: 'd1',
        primaryProfileId: 'lp1',
        omProfileId: 'lp2',
        hiringRhProfileId: 'lp3',
        createdAt: 0,
        updatedAt: 0,
      } as unknown as SystemLlmDefaults;
    ...
    it('NewAgentProvider type', () => {
      const p = {
        ...
        providerType: 'github-app',
        encryptedCredentials: '{}',
      } as unknown as NewAgentProvider;
      expect(p.agentId).toBe('a1');
    });
    ...
    it('SystemIntegration type', () => {
      const i = {
        ...
        createdAt: 0,
        updatedAt: 0,
      } as unknown as SystemIntegration;
    ...
    it('NewSystemIntegration type', () => {
      const i = {
        ...
        encryptedConfig: '{}',
      } as unknown as NewSystemIntegration;
    ...
    it('InternalChatAccount type', () => {
      const a = {
        ...
        createdAt: 0,
        updatedAt: 0,
      } as unknown as InternalChatAccount;
    ...
    it('InternalChatConversation type', () => {
      const c = {
        ...
        createdAt: 0,
        updatedAt: 0,
      } as unknown as InternalChatConversation;
    ...
    it('NewInternalChatConversation type', () => {
      const c = {
        ...
        name: 'random',
        createdByAccountId: null,
      } as unknown as NewInternalChatConversation;
    ...
    it('InternalChatConversationMember type', () => {
      const m = {
        ...
        createdAt: 0,
        updatedAt: 0,
      } as unknown as InternalChatConversationMember;
    ...
    it('NewInternalChatConversationMember type', () => {
      const m = {
        ...
        role: 'admin',
        createdAt: 0,
      } as unknown as NewInternalChatConversationMember;
    ...
    it('NewInternalChatMessage type', () => {
      const m = {
        ...
        authorAccountId: 'ca1',
        content: 'Hi',
      } as unknown as NewInternalChatMessage;
    ...
    it('InternalChatMessageRead type', () => {
      const r = {
        ...
        createdAt: 0,
        updatedAt: 0,
      } as unknown as InternalChatMessageRead;
    ...
    it('NewInternalChatMessageRead type', () => {
      const r = {
        ...
        messageId: 'msg2',
        readAt: 0,
      } as unknown as NewInternalChatMessageRead;
    ...
    it('InternalChatMessageAttachment type', () => {
      const a = {
        ...
        createdAt: 0,
        updatedAt: 0,
      } as unknown as InternalChatMessageAttachment;
    ...
    it('NewLlmModelPrice type', () => {
      const p = {
        ...
        inputCachePerMillionUsd: 0.5,
        outputPerMillionUsd: 10,
      } as unknown as NewLlmModelPrice;
    ...
    it('CompanyCashLedgerEntry type', () => {
      const e = {
        ...
        createdAt: 0,
        updatedAt: 0,
      } as unknown as CompanyCashLedgerEntry;
    ...
    it('NewCompanyCashLedgerEntry type', () => {
      const e = {
        ...
        direction: 'inflow',
        amountUsd: 50,
      } as unknown as NewCompanyCashLedgerEntry;
    ...
    it('CompanyRecurringPayable type', () => {
      const p = {
        ...
        createdAt: 0,
        updatedAt: 0,
      } as unknown as CompanyRecurringPayable;
    ...
    it('NewCompanyRecurringPayable type', () => {
      const p = {
        ...
        recurrencePeriod: 'monthly',
        nextDueAt: 0,
      } as unknown as NewCompanyRecurringPayable;
      expect(p.name).toBe('Sub');
    });
  });
});
