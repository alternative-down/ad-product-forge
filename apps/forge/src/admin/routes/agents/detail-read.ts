...
export function registerAgentStepsRoutes(httpServer: ForgeHttpServerAdapter, db: Database) {
  httpServer.registerRoute({
    method: 'GET',
...
export function registerAgentMetricsRoutes(httpServer: ForgeHttpServerAdapter, db: Database) {
  httpServer.registerRoute({
    method: 'GET',
...
export function registerAgentContractRoutes(httpServer: ForgeHttpServerAdapter, db: Database) {
  httpServer.registerRoute({
    method: 'GET',
...
export function registerAgentMcpRoutes(httpServer: ForgeHttpServerAdapter, db: Database) {
  httpServer.registerRoute({
    method: 'GET',
    ...
    handler: async (request) => {
      try {
        ...
        const serverIdToLink = new Map(
          agentMcpRows.map((link: { serverId: string; id: string }) => [link.serverId, link]),
        );
        return jsonResponse({
...
export function registerAgentSchedulesRoutes(httpServer: ForgeHttpServerAdapter, db: Database) {
  httpServer.registerRoute({
    method: 'GET',
...
export function registerAgentNotificationsRoutes(httpServer: ForgeHttpServerAdapter, db: Database) {
  httpServer.registerRoute({
    method: 'GET',
