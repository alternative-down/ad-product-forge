...
interface ReadModel {
  ...
  listAgentThreadMessages: (query: { agentId: string; page?: number; perPage?: number }) => Promise<unknown>;
  listAgentLongTermMemoryThreadMessages: (query: { agentId: string; page?: number; perPage?: number }) => Promise<unknown>;
  ...
  listAgentConversationMessages: (query: { agentId: string; provider?: string; targetKey?: string; limit?: number; offset?: number }) => Promise<unknown>;
}
