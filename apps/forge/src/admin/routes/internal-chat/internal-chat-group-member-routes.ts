...
export function registerGroupMemberRoutes(
  ...
  httpServer.registerRoute({
    ...
    handler: buildListGroupMembersHandler(internalChat),
  });
  httpServer.registerRoute({
    method: 'POST',
    path: '/admin/internal-chat/group-member/add',
    handler: buildAddMemberHandler(internalChat),
  });
  httpServer.registerRoute({
    method: 'POST',
    path: '/admin/internal-chat/group-member/update-role',
    handler: buildUpdateRoleHandler(internalChat),
  });
  httpServer.registerRoute({
    method: 'POST',
    path: '/admin/internal-chat/group-member/remove',
    handler: buildRemoveMemberHandler(internalChat),
  });
}
