  ...
  async function createRole(input: { name: string; description?: string }) {
    ...
    try {
      ...
      forgeDebug({
        ...
        context: { name: input.name, error: err instanceof Error ? err.message : String(err) },
      });
      throw err;
    }
  ...
  async function updateRole(input: { roleId: string; name?: string; description?: string | null }) {
    ...
    try {
      ...
      forgeDebug({
        ...
        context: { roleId: input.roleId, error: err instanceof Error ? err.message : String(err) },
      });
      throw err;
    }
  ...
  async function listRoleToolPermissions(roleId: string) {
    ...
    try {
      ...
      forgeDebug({
        ...
        level: 'error',
        message:
          'listRoleToolPermissions DB read failed: ' +
  ...
  async function listRoleWorkflowPermissions(roleId: string) {
    ...
    try {
      ...
      forgeDebug({
        ...
        level: 'error',
        message:
          'listRoleWorkflowPermissions DB read failed: ' +
          (err instanceof Error ? err.message : String(err)),
      });
      return [];
    }
  ...
  async function listRoleCapabilities(roleId: string) {
    ...
    try {
      ...
      forgeDebug({
        ...
        context: { roleId, error: err instanceof Error ? err.message : String(err) },
      });
      throw err;
    }
  ...
  async function listAgentStatuses(input: {
    ...
    try {
      ...
      forgeDebug({
        ...
        level: 'error',
        message:
          'listAgentStatuses DB read failed: ' + (err instanceof Error ? err.message : String(err)),
      });
      return [];
    }
