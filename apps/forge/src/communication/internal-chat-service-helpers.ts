 ...
 * Compatible with what createInternalChatAccounts exports.
 */
...
/**
 * Minimal participants listing shape used by helper functions.
 */
...
export interface ServiceHelpersDeps {
  db: Database;
  /** Account lookup functions from createInternalChatAccounts */
  accounts: {
  ...
  /** Participant listing from createInternalChatParticipants */
  participants: {
