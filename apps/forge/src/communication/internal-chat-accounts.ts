  ...
  async function registerAgentAccount(input: {
    ...
    try {
      ...
      forgeDebug({
        ...
        level: 'error',
        message: 'registerAgentAccount DB insert failed',
  ...
  async function registerExternalAccount(input: {
    ...
    try {
      ...
      forgeDebug({
        scope: 'internal-chat-accounts',
        level: 'error',
        message: 'registerExternalAccount DB insert failed',
        context: { error: err instanceof Error ? err.message : String(err) },
      });
      throw err;
    }
  ...
  async function updateExternalAccount(input: {
    ...
    try {
      ...
      forgeDebug({
        scope: 'internal-chat-accounts',
        level: 'error',
        message: 'updateExternalAccount DB update failed',
        context: { error: err instanceof Error ? err.message : String(err) },
      });
      throw err;
    }
  ...
  async function deleteExternalAccount(input: { accountId: string }) {
    try {
      ...
      forgeDebug({
        scope: 'internal-chat-accounts',
        level: 'error',
        message: 'deleteExternalAccount DB delete failed',
        context: { error: err instanceof Error ? err.message : String(err) },
      });
      throw err;
    }
  ...
  async function listAccounts(input: { excludeAgentId?: string } = {}) {
    try {
      ...
      forgeDebug({
        scope: 'internal-chat-accounts',
        level: 'error',
        message: 'listAccounts DB query failed',
        context: { error: err instanceof Error ? err.message : String(err) },
      });
      throw err;
    }
  ...
  async function getAccountBySlug(slug: string) {
    try {
      ...
      forgeDebug({
        scope: 'internal-chat-accounts',
        level: 'error',
        message: 'getAccountBySlug DB query failed',
        context: { error: err instanceof Error ? err.message : String(err) },
      });
      throw err;
    }
  ...
  async function getAccountByAgentId(agentId: string) {
    try {
      ...
      forgeDebug({
        scope: 'internal-chat-accounts',
        level: 'error',
        message: 'getAccountByAgentId DB query failed',
        context: { error: err instanceof Error ? err.message : String(err) },
      });
      throw err;
    }
  ...
  async function getAccountByTargetKey(targetKey: string) {
    try {
      ...
      forgeDebug({
        scope: 'internal-chat-accounts',
        level: 'error',
        message: 'getAccountByTargetKey DB query failed',
        context: { error: err instanceof Error ? err.message : String(err) },
      });
      throw err;
    }
  ...
  async function getRequiredAccount(accountId: string) {
    try {
      ...
      forgeDebug({
        scope: 'internal-chat-accounts',
        level: 'error',
        message: 'getRequiredAccount DB query failed',
        context: { error: err instanceof Error ? err.message : String(err) },
      });
      throw err;
    }
  ...
  async function getAccountsById(accountIds: string[]) {
    try {
      ...
      forgeDebug({
        scope: 'internal-chat-accounts',
        level: 'error',
        message: 'getAccountsById DB query failed',
        context: { error: err instanceof Error ? err.message : String(err) },
      });
      throw err;
    }
  ...
  async function getRequiredAgentAccount(agentId: string) {
    try {
      ...
      forgeDebug({
        scope: 'internal-chat-accounts',
        level: 'error',
        message: 'getRequiredAgentAccount DB query failed',
        context: { error: err instanceof Error ? err.message : String(err) },
      });
      throw err;
    }
  ...
  async function getRequiredAccountBySlug(slug: string) {
    try {
      ...
      forgeDebug({
        scope: 'internal-chat-accounts',
        level: 'error',
        message: 'getRequiredAccountBySlug DB query failed',
        context: { error: err instanceof Error ? err.message : String(err) },
      });
      throw err;
    }
  ...
  async function getConversationForAgent(agentId: string, conversationId: string) {
    try {
      ...
      forgeDebug({
        scope: 'internal-chat-accounts',
        level: 'error',
        message: 'getConversationForAgent DB query failed',
        context: { error: err instanceof Error ? err.message : String(err) },
      });
      throw err;
    }
  ...
  async function ensureDirectConversation(leftAccountId: string, rightAccountId: string) {
    try {
      ...
      forgeDebug({
        scope: 'internal-chat-accounts',
        level: 'error',
        message: 'ensureDirectConversation DB operation failed',
        context: { error: err instanceof Error ? err.message : String(err) },
      });
      throw err;
    }
  ...
  async function listGroupMembersOrDmPeersByAccount(accountId: string, conversationId: string) {
    try {
      ...
      forgeDebug({
        scope: 'internal-chat-accounts',
        level: 'error',
        message: 'listGroupMembersOrDmPeersByAccount DB query failed',
        context: { error: err instanceof Error ? err.message : String(err) },
      });
      throw err;
    }
