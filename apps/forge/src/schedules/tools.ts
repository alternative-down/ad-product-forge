...
const manageSelfCronsInputSchema = z.object({
  ...
  create: z.object({
    ...
    cronExpression: z.string().nullish().describe('Required when scheduleType is cron. Example: 0 * * * *.'),
    scheduledDate: z.string().nullish().describe('Required when scheduleType is date. Use an ISO string.'),
  ...
  update: z.object({
    ...
    name: z.string().nullish().describe('New cron name.'),
    ...
    cronExpression: z.string().nullish().describe('Optional new cron expression.'),
    scheduledDate: z.string().nullish().describe('Optional new one-time execution date.'),
    timezone: z.string().nullish().describe('Optional new timezone.'),
    content: z.string().nullish().describe('Optional new content.'),
