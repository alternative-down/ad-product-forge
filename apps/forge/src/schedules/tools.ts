    ...
    execute: async () => {
      ...
      try {
        ...
        forgeDebug({
          ...
          level: 'error',
          message:
            'list_self_crons failed: ' + (error instanceof Error ? error.message : String(error)),
        });
        return {
          valid: false,
        ...
        if (input.action === 'create') {
          ...
          try {
            ...
            forgeDebug({
              ...
              level: 'error',
              message:
                'manage_self_crons action=create failed: ' +
        ...
        if (input.action === 'update') {
          ...
          try {
            ...
            forgeDebug({
              ...
              level: 'error',
              message:
                'manage_self_crons action=update failed: ' +
                (error instanceof Error ? error.message : String(error)),
            });
            return {
              valid: false,
      ...
      execute: async (input) => {
        ...
        try {
          ...
          forgeDebug({
            ...
            level: 'error',
            message:
              'list_crons failed: ' + (error instanceof Error ? error.message : String(error)),
          });
          return {
            valid: false,
            error: error instanceof Error ? error.message : String(error),
        ...
        if (input.action === 'create') {
          ...
          try {
            ...
            forgeDebug({
              ...
              level: 'error',
              message:
                'manage_crons action=create failed: ' +
                (error instanceof Error ? error.message : String(error)),
            });
            return {
              valid: false,
        ...
        if (input.action === 'update') {
          ...
          try {
            ...
            forgeDebug({
              ...
              level: 'error',
              message:
                'manage_crons action=update failed: ' +
                (error instanceof Error ? error.message : String(error)),
            });
            return {
              valid: false,
