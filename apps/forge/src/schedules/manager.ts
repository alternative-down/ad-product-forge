...
function createHeartbeatWakeInstruction(content?: string) {
  ...
  const lines = [
    ...
    '  What to do: recover current objectives, active tasks, durable facts, learned constraints, pending observations, and anything that affects the work you are about to touch. Do not stop at rereading; decide what these records imply about what should happen next.',
    ...
    '  What to do: read the files that matter for the current front, recover prior analysis, decisions, open questions, and unfinished threads, and use that material to resume work with continuity. Reflect on what those notes reveal, what they are missing, and what action they now justify.',
    '',
    ...
    '  What to do: while updating working memory and workspace files, explicitly refine what you believe, what you learned, what remains uncertain, and what concrete actions follow from that.',
    '- Avoid duplication.',
