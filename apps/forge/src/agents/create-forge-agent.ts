...
>(
  ...
  const runtimeMemory = await createAgentRuntimeMemory({
    ...
    ltmRecallSearchMode: config.ltmRecallSearchMode,
    ltmRecallWorkspaceTopK: config.ltmRecallWorkspaceTopK,
    ltmRecallGraphTopK: config.ltmRecallGraphTopK,
    ltmRecallGraphThreshold: config.ltmRecallGraphThreshold,
    ltmRecallGraphRandomWalkSteps: config.ltmRecallGraphRandomWalkSteps,
    ltmRecallGraphIncludeSources: config.ltmRecallGraphIncludeSources,
    workspaceEmbedder: config.workspaceEmbedder,
