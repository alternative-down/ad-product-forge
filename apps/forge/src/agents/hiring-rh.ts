...
export async function generateHiredAgentInstructions(
  ...
  const agent = new Agent({
    ...
    instructions: [
      ...
      '',
      '### Backstory',
      '- Write 2-3 paragraphs grounded in the real-world professional background of the function.',
      '- Focus on: domain knowledge, relevant experience, operating discipline, standards, and how the function approaches problems in practice.',
      '- AVOID: fictional worlds, character lore, whimsical archetypes, mascots, jokes, or cartoon framing.',
      '- The backstory must read like a serious professional profile for the real function being hired.',
      ...
      '- Everything except the name must stay grounded in the real professional function and real operating context of the work.',
...
function buildHiringPrompt(input: {
  ...
  const sections = [
    ...
    'The professional profile, backstory, goals, and instructions must be grounded in the real-world function and how that function operates in practice.',
