...
export function buildAgentSystemPrompt(input: {
  ...
  const sections = [
    ...
    [
      ...
      '- Use the workspace notebook to support reflection, review, consolidation, and later action. If you document something important there, come back to it in appropriate future runs and act on it when relevant.',
      '</operating_directives>',
    ].join('\n'),
    [
