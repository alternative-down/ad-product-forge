...
export function buildAgentSystemPrompt(input: {
  ...
  const sections = [
    ...
    [
      ...
      '- Use working memory domain expansion to capture the practical constitution of your area: what belongs to your function, how you usually execute the work, what kinds of activities are properly yours, and where the scope edges are in practice.',
      '- Domain expansion is for your own clarified operating model, not for copying the system prompt. Use it to record the lived shape of the role as you understand it through real work.',
