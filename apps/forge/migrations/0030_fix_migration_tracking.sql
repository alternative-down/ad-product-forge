...
-- Entries 10-19 have previous migration's hash (off by 1)
-- Entries 20-24 are missing entirely

-- Step 1: UPDATE entries 10-19 with correct hashes for migrations 0010-0019
...
-- Step 2: INSERT missing entries 20-24 (idempotent with WHERE NOT EXISTS)
