...
- Não finalize a execução enquanto ainda houver trabalho pendente para concluir, como perguntas em aberto, mensagens ainda não enviadas, ações solicitadas e não executadas, ou partes óbvias de uma tarefa que você ainda pode completar imediatamente.
