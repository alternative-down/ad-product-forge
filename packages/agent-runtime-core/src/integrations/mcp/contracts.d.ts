...
export type McpJsonSchema = boolean | {
    type?: string | string[];
    description?: string;
    enum?: unknown[];
    const?: unknown;
...
export type McpRuntimeActionFactory = {
    createActionDefinitions(session: McpSession, options?: McpRuntimeActionOptions): Promise<Array<RuntimeActionDefinition<Record<string, unknown>, unknown>>>;
};
